...
import type { CrisisSupportQuery, CrisisSupportQueryVariables } from "@/tina/__generated__/types";
...
interface CrisisSupportClientProps {
  query: string;
  variables: CrisisSupportQueryVariables;
  data: CrisisSupportQuery;
}

export default function CrisisSupportClient(props: CrisisSupportClientProps) {
  const { data: tinaData } = useTina(props);
  const data = tinaData.crisisSupport as CrisisData;
